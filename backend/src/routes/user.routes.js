...
import { addUser, deleteUser, getAllUsers, getCurrentUser, getUserById, MyteamUsers, updateUser, updateUserSettings } from "../controllers/auth.controller.js";
...
Userrouter.get('/my-teams',authenticate,MyteamUsers);
